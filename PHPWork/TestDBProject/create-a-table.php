...
<p> This uses the file mydatabase.php which you need to have added your credentials to.</p>
...
if (mysqli_query($dbhandle, $sql)) {
    echo "Table $newtable created successfully, or already exists";
} else {
