...
?>
<div class="report">Generating an input form to match the columns in the table <?php echo $mytable ?> . In script c_form.php</div>
<?php
...
if($webdata['action'] == 'delete'){
	?>
	<div class="report">Action to delete has been confirmed.In script c_form.php</div>
...
elseif($webdata['action'] == 'edit'){
				...
				?>
					<div class="report">Action to edit has been confirmed.In script c_form.php</div>
...
?>
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"  name = "tt284guestform<?php echo $row["id"]; ?>" >
