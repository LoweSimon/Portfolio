...
function fieldcheck(id){  //check if the field represented by the unique identifier id is valid.
    ...
    fbid = "fb"+id;                                          // add prefix to get assoaciated feedback unique id.
                                                             // We can do this because in the HTML we decided every element would have a 
                                                             // corresopnding feedback element prefixed with "fb"
    ...
    var failmessage;                                         // variable to hold message shoudl test fail
